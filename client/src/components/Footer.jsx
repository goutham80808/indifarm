...
import { subscribeToNewsletter, getSubscriberCount } from "../redux/slices/newsletterSlice";
...
const Footer = () => {
  ...
  const { loading, subscriberCount } = useSelector((state) => state.newsletter);

  useEffect(() => {
    // Get subscriber count when component mounts
    dispatch(getSubscriberCount());
  }, [dispatch]);
  ...
  const handleSubmit = (e) => {
    ...
    if (emailRegex.test(email)) {
      ...
      // This will be handled by the Redux slice toast
      return;
    }
  };
    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl font-bold">IndiFarm</h3>
            </div>
            ...
            {subscriberCount > 0 && (
              <p className="text-sm text-green-400">
                {subscriberCount} people are already subscribed to our newsletter!
              </p>
            )}
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>6304035489</span>
              </li>
              <li className="flex items-center gap-3">
                <FaEnvelope className="text-green-400" />
                <span>info@indifarm.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-center text-gray-500 text-sm">
          <p>&copy; {currentYear} IndiFarm. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
