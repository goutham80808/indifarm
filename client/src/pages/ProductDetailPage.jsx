...
import { filterValidImages, getValidImageByIndex } from "../utils/imageUtils";
...
const ProductDetailPage = () => {
  ...
  // Filter out invalid blob URLs and ensure only valid image URLs are used
        ...
        <div>
          <div className="bg-gray-100 rounded-lg overflow-hidden mb-4 h-80">
            {validImages.length > 0 ? (
              <img
                src={getValidImageByIndex(validImages, activeImage, placeholder)}
                alt={product.name}
