...
const EditProductPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    quantityAvailable: "",
    isOrganic: false,
    images: [], // This will store File objects, not blob URLs
  });
  const [imagePreviewUrls, setImagePreviewUrls] = useState([]); // This will store blob URLs for preview only
  ...
  useEffect(() => {
    if (product) {
      ...
      // Filter out blob URLs when setting initial image preview URLs
  ...
  const handleImageChange = (e) => {
    ...
    setFormData({
      ...formData,
      images: [...formData.images, ...files], // Store File objects, not blob URLs
    });
  };
