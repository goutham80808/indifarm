...
import { getSubscriberCount } from "../../redux/slices/newsletterSlice";
import Loader from "../../components/Loader";
import { FaUsers, FaList, FaBox, FaUserCheck, FaEnvelope } from "react-icons/fa6";
...
const DashboardPage = () => {
  ...
  const { subscriberCount, loading: newsletterLoading } = useSelector(
  ...
  if (usersLoading || ordersLoading || categoriesLoading || productsLoading || newsletterLoading) {
    return <Loader />;
  }
                      ...
                      <td className="py-3">
                        <div className="flex items-center">
                          <div className="w-8 h-8 bg-gray-100 rounded-lg overflow-hidden mr-2">
                            <img
                              src={getValidImage(product.images, "/placeholder.svg")}
                              alt={product.name}
